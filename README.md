...
A step counting and calorie tracking application developed for the FRDM KL03 evaluation board. Built the [Warp firmware] platform (https://github.com/physical-computation/Warp-firmware) developed by the University of Cambridge's [Physical Computation Laboratory](http://physcomp.eng.cam.ac.uk). 
